 ...
 * MAILWIZZ_BASE_URL
 * MAILWIZZ_API_KEY
 * NETKANT_NEWSLETTER_LIST_ID
 * NETKANT_NEWSLETTER_FROM_NAME
 * NETKANT_NEWSLETTER_FROM_EMAIL
 * NETKANT_NEWSLETTER_REPLY_TO
 */
...
function post_campaigns_create_campaign($post_title, $post_content, $args = array()) {
    ...
    $campaign = array(
        ...
        'type'       => 'regular',
        'from_name'  => NETKANT_NEWSLETTER_FROM_NAME,
        'from_email' => NETKANT_NEWSLETTER_FROM_EMAIL,
        'subject'    => $post_title,
        'reply_to'   => NETKANT_NEWSLETTER_REPLY_TO,
        'send_at'    => wp_date('Y-m-d H:i:s'),
        'list_uid'   => NETKANT_NEWSLETTER_LIST_ID,
        'options'    => array(
            'open_tracking'    => 'no',
            'url_tracking'     => 'no',
            'json_feed'        => 'no',
